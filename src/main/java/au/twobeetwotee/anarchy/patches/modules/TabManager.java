...
public class TabManager extends Module {
    ...
    public Module onEnable() {
        ...
        AnarchyPatches.getScheduler().runTaskTimer(
                AnarchyPatches.getPlugin(),
                tabList,
                0L,
                Config.TABUPDATEDELAY);

//        AnarchyPatches.getHookManager()
//                .getHook(ProtocolLibHook.class)
//                .add(new PacketAdapter(AnarchyPatches.getPlugin(), ListenerPriority.HIGHEST, PacketType.Play.Server.PLAYER_INFO)
//        {
//            @Override
...
//        });
    ...
    private String parseText(Player player, String text) {
        ...
        if (AnarchyPatches.getHookManager().getHook(PlaceholderHook.class).isPapiEnabled()) {
        ...
        newText = newText
                ...
                .replaceAll("%uptime%", this.getFormattedInterval(System.currentTimeMillis() - AnarchyPatches.getStartMillis()))
    ...
    private TextComponent getTps() {
        return this.formatTps(AnarchyPatches.getHookManager().getHook(SparkHook.class).getTPS_10SEC());
    }
